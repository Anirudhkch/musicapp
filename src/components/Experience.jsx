...
function Experience() {
  return (
    ...
    <div className="headline mt-7 flex flex-col items-center text-[2rem]">
      <span>
        An amazing that can help me learn new things
      </span>
      <span><b>Music Experience</b></span>
    </div>

    {/* features */}
    {/* seperate file for features beacuse making a reusable component */}
    <div className="features flex items-center justify-around mt-24 w-[100%]">
